...
namespace Roguelike.Core.Entity_System.Behaviours {
    public class RunAway : IBehaviour {
        ...
        //This behaviour consists of away from
        //the target and, if necessary, attacking them
        ...
        public bool Act(Monster monster, CommandSystem commandSystem, PathfindingSystem pathfindingSystem) {
            ...
            Cell path = null;
            if (monster.turnsAlterted.HasValue) {
                //Use the pathfinding system to find the ideal cell to
                //move to (in order to escape the pursing target)
